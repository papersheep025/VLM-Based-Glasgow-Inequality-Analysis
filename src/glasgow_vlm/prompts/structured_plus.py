...
_FORMAT_RULES = (
    ...
    "The JSON must contain exactly these sixteen keys: "
    "income, employment, health, education, housing, access, crime (each an integer 1–10), "
    "overall (a float), "
    "and the following eight intermediate variable scores (each an integer 1–10): "
    "built_environment_quality_score, infrastructure_adequacy_score, residential_environment_quality_score, "
    "connectivity_accessibility_score, commercial_economic_activity_score, "
    "night_time_activity_coverage_score, open_space_greenery_score, spatial_marginality_score. "
    "Do not include evidence, reasoning, or any other fields in the output. "
    "All sixteen keys must always be present. Before outputting, verify the JSON is complete and valid."
)
...
_SCHEMA_EXAMPLE = json.dumps({
    ...
    "infrastructure_adequacy_score": 5,
    "residential_environment_quality_score": 4,
    "connectivity_accessibility_score": 5,
    "commercial_economic_activity_score": 3,
    "night_time_activity_coverage_score": 4,
    "open_space_greenery_score": 6,
    "spatial_marginality_score": 6,
}, ensure_ascii=False)
