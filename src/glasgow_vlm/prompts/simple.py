...
_SCORING_RULES = (
    "Score each SIMD dimension directly from the images on a scale of 1–10 "
    "(1=most deprived, 10=least deprived). "
    "Dimension-specific guidance: "
    "income — proxy via residential quality, maintenance, spatial vacancy, and commercial decline indicators. "
    "employment — proxy via commercial/industrial activity, transport links, and area vitality; "
    "do NOT equate 'industrial land nearby' with poor employment. "
    "health — proxy via green space, walkability environment, pollution exposure cues, "
    "open space, and active travel infrastructure. "
    "education — image evidence is weak; use school/educational facility visibility and environmental quality "
    "as weak proxies only; if uncertain, default to 5. "
    "housing — infer from housing condition, density, maintenance, roof quality (satellite), "
    "and surrounding environment. "
    "access — focus on road network, centrality, connectivity, transit cues, and night-time lighting continuity. "
    "crime — infer only from environmental management cues: graffiti, vandalism, security fixtures, "
    "abandoned sites, street lighting, and activity level; "
